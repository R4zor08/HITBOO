...
import type { Local2pLoadout, MapId } from '../types';
...
export function Local2pPrematchFlow({
  ...
  const p1Weapon = getWeaponById(p1WeaponId);
  const p2Weapon = getWeaponById(p2WeaponId);
        ...
        <div className="w-full max-w-3xl mx-auto space-y-6">
          ...
          {step === 'versus' && (
            <div className="space-y-6">
              ...
              <GlassCard
                variant="sticker"
                className="mx-auto flex max-w-md items-center gap-4 border-neon-lime/30 p-4">
                <motion.div
                ...
                <div>
                  ...
                  <p className="font-display text-xs text-gray-400">{arena.theme}</p>
                </div>
              </GlassCard>
